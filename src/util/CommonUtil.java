...
public class CommonUtil {
	 ...
	 */
	public static void getObj(HttpServletRequest request, Object obj, String datePattern) {
		...
		try {
			...
			if(null == datePattern){
				patterns = new String[] { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss" };
			}else{
				patterns = new String[] { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", datePattern };
			}
			// 设置日期转换格式
