	 ...
	 */
		...
		public String toString() {
			return "Course [id=" + id + ", course_name=" + course_name
					+ ", author=" + author + ", cover_image_url="
					+ cover_image_url + ", create_date=" + create_date
					+ ", create_datestr=" + create_datestr + ", end_datestr="
					+ end_datestr + ", click_number=" + click_number
					+ ", status=" + status + ", recommendation_grade="
					+ recommendation_grade + ", courseType=" + courseType + "]";
		}
